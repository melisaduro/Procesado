IF object_ID(N'[dbo].[sp_MDD_Voice_Libro_Dropped_Calls]') IS NOT NULL
              DROP PROCEDURE [dbo ].[sp_MDD_Voice_Libro_Dropped_Calls]
GO
CREATE PROCEDURE [dbo].[sp_MDD_Voice_Libro_Dropped_Calls] (
